// This code generates Figure A1 in the paper
...
main()
{
	...
	DrawXMatrix(0,data["y1"],"Martinez (2020): Gets Model",data["x1"],"",0,4);
	DrawAdjust(ADJ_COLOR, -1, 12);
	DrawXMatrix(0,data["y2"],"Bakkensen and Mendelson (2016)",data["x2"],"",0,2);
	DrawAdjust(ADJ_COLOR, -1, 12);
